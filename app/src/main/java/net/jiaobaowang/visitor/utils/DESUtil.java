...
public class DESUtil {
    private static String DES(String key, String strMessage, boolean isEncrypt, int mode, String strIV) {
        ...
        while (m < len) {
            ...
            left ^= (temp << 4);
            if (isEncrypt) {
                tempresult.append((char) (left >>> 24));
                tempresult.append((char) ((left >>> 16) & 0xff));
                tempresult.append((char) ((left >>> 8) & 0xff));
                tempresult.append((char) (left & 0xff));
                tempresult.append((char) (right >>> 24));
                tempresult.append((char) ((right >>> 16) & 0xff));
                tempresult.append((char) ((right >>> 8) & 0xff));
                tempresult.append((char) (right & 0xff));
            } else {
                tempresult.append((char) ((((left >>> 16) & 0xffff))));
                tempresult.append((char) ((left & 0xffff)));
                tempresult.append((char) (((right >>> 16) & 0xffff)));
