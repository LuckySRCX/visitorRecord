...
/**
 * 打印条码
 * Created by ShangLinMo on 2018/1/2.
 */

public class PrinterCodeUtils {
    /**
     * 生成条码
     *
     * @param str       条码内容
    ...
    public static Bitmap CreateCode(String str, com.google.zxing.BarcodeFormat type, int bmpWidth, int bmpHeight)
